    ...
    mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer), mpMap(pMap), mnLastRelocFrameId(0), mpPointCloudMapper( pPointCloud )
{
    ...
    mMinFrames = 0;
    mMaxFrames = fps*0.5;//there is no *0.5 before
...
/*
    ...
    std::cout << "Frame time =" << tFrame*1000 <<  std::endl;
*/
    ...
    std::cout << "Track time =" << tTrack*1000 <<  std::endl;
    */
...
void Tracking::Track()
{
    ...
    else
    {
        ...
        if(mState==LOST)
        {
            ...
            {
                std::cout<<"Keyframesinmap"<<mpMap->KeyFramesInMap()<<std::endl;
...
bool Tracking::NeedNewKeyFrame()
{
    ...
    const bool c1c =  mSensor!=System::MONOCULAR && (mnMatchesInliers<nRefMatches*0.25 || ratioMap< 0.3) ;
    ...
    /*below is original orbslam2 source code 
